"""Python Practice Lab — Reed & Zelle patterns. Run from repo root: python learning_apps/python_practice_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "Python Practice Lab"
APP_DESCRIPTION = "Reed & Zelle: problem decomposition, algorithm patterns, data structures, code organization."
try:
