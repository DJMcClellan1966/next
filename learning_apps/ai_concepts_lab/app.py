"""AI Concepts Lab — Russell & Norvig style (game theory, search, RL). Run from repo root: python learning_apps/ai_concepts_lab/app.py"""
import sys
...
for p in (str(REPO_ROOT), str(LAB_DIR)):
    if p not in sys.path:
        sys.path.insert(0, p)
APP_TITLE = "AI Concepts Lab"
APP_DESCRIPTION = "Game theory, search & planning, reinforcement learning, probabilistic reasoning (Russell & Norvig style)."
try:
