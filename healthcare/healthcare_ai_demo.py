...
def main():
    ...
    print("="*70)
    print("  [X] This is EXPERIMENTAL DEMONSTRATION software ONLY")
    print("  [X] NOT HIPAA-compliant - DO NOT use with patient data")
    print("  [X] NOT clinically validated - DO NOT use for clinical decisions")
    print("  [X] NOT production-ready - Missing security, privacy, validation")
    print("  [X] Uses general embeddings, not medical domain models")
    print("  [X] Limited medical knowledge (demonstrative examples only)")
    print("="*70)
    print("  For production healthcare AI, use established biomedical LLMs")
    print("  (MedLLaMA, ClinicalCamel) via Ollama or professional platforms")
    print("="*70)
    print("  See healthcare/LIMITATIONS.md for detailed warnings")
    print("="*70 + "\n")
